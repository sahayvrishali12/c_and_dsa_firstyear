...
void askQuestions(Student *student) {
    ...
    printf("INSTRUCTIONS:\nYou will be asked %d questions. For each question, choose the correct answer from the options provided.\n", MAX_QUESTIONS);
    printf("If you do not know the answer, you can choose to skip the question by selecting option 5.\n\n");
